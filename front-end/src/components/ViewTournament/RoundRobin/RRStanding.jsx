    ...
    return (
        <>
            ...
            <div className='w-2/3 m-auto my-[10vh]'>
                <div className='w-full rounded-md p-2 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 hover:bg-gradient-to-r hover:from-yellow-500 hover:to-pink-500 text-center text-white text-lg font-bold'>Point Table</div>
