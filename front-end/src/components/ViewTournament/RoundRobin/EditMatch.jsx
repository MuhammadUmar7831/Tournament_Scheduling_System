...
export default function (props) {
    ...
    const { editMatchDate, editMatchVenue } = useContext(ViewContext);
                        ...
                        <form className="p-4 md:p-5" onSubmit={handleEditSubmit}>
                            ...
                            <div className="grid gap-4 mb-4 grid-cols-1">
                                ...
                                <div className='flex justify-between'>
                                    <TimePicker header={"Start Time"} time={props.match.time.startTime}/>
                                    <TimePicker header={"End Time"} time={props.match.time.endTime}/>
                                </div>
                            </div>
