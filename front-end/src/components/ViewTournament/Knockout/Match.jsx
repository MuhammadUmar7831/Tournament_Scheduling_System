...
export default function Match(props) {
    ...
    const isThisMatchTheLastMatchofTeam = () => {
        const isThisTheNewMatchToUpdateNext = (props.lastMatch + 1 === props.match.number);
        const isThisMatchLastMatchOfBothTeams = (props.match.number === team1.lastMatch && props.match.number === team2.lastMatch);
        const isThisMatchTheLastMatchThatWasUpdates = (props.match.number === props.matches.lastMatch);
    ...
    const isThisMatchGroupIsCurrentGroup = () => {
        ...
        for (let i = 1; i < props.currentStage; i++) {
            matchNo += props.totalTeams / (Math.pow(2, i));
        }
