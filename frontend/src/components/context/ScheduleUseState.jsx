...
const ScheduleUseState = (props) => {
    ...
    return (
        <ScheduleContext.Provider value={{ setTournamentName, selectedSport, setSelectedSport, noteams, setNoTeams, dates, setDates, venues, addNewVenue, removeVenue, teamNames, setTeamNames, setMatchFormat, matchFormat, getSchedules, schedules, addSchedule, somethingWrong, setSomethingWrong, getDetail, detail, pin, setPin, noTimeSlots, startingTimes, endingTimes, setNoTimeSlots, setStartingTimes, setEndingTimes }}>
            {props.children}
