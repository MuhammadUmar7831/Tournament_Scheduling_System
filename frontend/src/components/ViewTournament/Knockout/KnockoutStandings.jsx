        ...
        <>
            <div className={`flex w-full h-20 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500`}>
                ...
                <div className="flex items-center justify-between h-full w-2/4 m-auto">
                    <p onClick={() => { navigate('/knockout/viewFixtures') }} className="mx-2 self-end text-white text-lg md:text-xl lg:text-xl border-b-4 border-b-yellow-500 hover:text-amber-400 hover:cursor-pointer hover:border-b-amber-400">Fixtures</p>
            ...
            <div className='w-3/4 flex m-auto flex-wrap-reverse'>
                {(detail)
